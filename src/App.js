    ...
    <div className="App">
      <div className="container">
        <div className="blogs">
          ...
          <p className="date"> 11th June,1996 </p>
          <h2 className="heading">This is my first blog post</h2>
          <p>
          ...
          <img src={require("./logo.jpg")} alt="logo" id="blog" />

          <h2 className="heading">HTML is amazing</h2>
          <p>
        ...
        <div className="author">
          <img src={require("./author.jpg")} alt="auther" id="author_pic" />
          <p id="author_name">Jackson Gonzalez</p>
        </div>
      </div>
    </div>
  );
